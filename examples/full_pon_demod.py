...
class full_pon_demod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_1_0.set_y_axis(-0.1, 0.1)
        ...
        self.qtgui_time_sink_x_0_1.set_y_axis(-0.1, 0.1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/4moulins/projects/gr-pon/sandbox/records/captura_pon_us_ch2_20250707_102056_f32.f32', False, 0, 0)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.pon_gpon_bwmap_parser_0, 'out'), (self.blocks_message_debug_0, 'print'))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.blocks_float_to_char_0, 0), (self.pon_gpon_bwmap_parser_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 2.5e9, 0.2e9, window.WIN_HAMMING, 6.76))
